# Equipment Manager
![ASP.NET Core](https://img.shields.io/badge/ASP.NET_Core-10.0.0-green) ![React](https://img.shields.io/badge/React-19.2.4-blue) ![SQL Server](https://img.shields.io/badge/SQL_Server-2019-red)
